...
## Playtest shell for Cinderwatch Ridge Graybox Pass 1.


const GAME_SCENE: PackedScene = preload("res://scenes/world/CinderwatchRidgeGame.tscn")
...
func _restart_gameplay() -> void:
	...
	print("CINDERWATCH | full reload | Ctrl+Shift+R")
