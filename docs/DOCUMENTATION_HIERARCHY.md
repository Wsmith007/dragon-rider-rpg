...
| [`world_design_framework.md`](./design/world_design_framework.md) | **World design constitution** -- persistent exploration, Sense of Place, memory-driven exploration, World->Region->Area->POI->Structure->Room hierarchy, place-making, navigation, contextual encounters, traversal/dragon exploration philosophy |
| [`exploration_framework.md`](./design/exploration_framework.md) | **Exploration production architecture** -- Area layers, lifecycle, connections, encounter-context language, graybox standards, Area review checklist |

**`vertical_slice_design_v1.md` wins for:** slice intent, feature scope, deferred features, fifteen-minute flow, enemy archetype *roles*, implementation roadmap *direction*.

**`world_design_framework.md` wins for:** world/exploration philosophy, Sense of Place, Place Identity, memory-driven exploration, Area design standards, place terminology, encounter *context* in space, reward classes for exploration, representative Area standards. Does not authorize gameplay implementation by itself.

**`exploration_framework.md` wins for:** how Areas are authored, layered, connected, grayboxed, and reviewed; encounter context cards; production checklist. Defers philosophy to World Design Framework; does not invent gameplay systems.

**None of the above win for:** live numeric tuning, exact AI constants, or code behavior -- use Level 2 checkpoints.
...
| [`project_checkpoint_combat_stakes_pass1.md`](./checkpoints/project_checkpoint_combat_stakes_pass1.md) | Readable HP/damage baseline, critical health feedback |
| [`project_checkpoint_dragon_survivability_pass1.md`](./checkpoints/project_checkpoint_dragon_survivability_pass1.md) | Dragon HP, soft targeting, interact revive, Sync/Instability, HUD |
| [`project_checkpoint_enemy_combat_identity_pass1.md`](./checkpoints/project_checkpoint_enemy_combat_identity_pass1.md) | Scout/Raider/Brute weapons + Brute charged rush |
...
| Document | Owns |
|----------|------|
| [`vertical_slice_level_p1.md`](./level/vertical_slice_level_p1.md) | Combat-era graybox layout, named encounters (sandbox) |
| [`cinderwatch_ridge.md`](./level/cinderwatch_ridge.md) | Cinderwatch implementation notes |
| [`project_checkpoint_cinderwatch_graybox_pass1.md`](./checkpoints/project_checkpoint_cinderwatch_graybox_pass1.md) | Cinderwatch Graybox Pass 1 validation outcome (failed; correction required) |
...
| [`game_architecture.md`](./design/game_architecture.md) | Full-game systems map -- politics, races, regions; exploration detail defers to World Design Framework |
| [`world_design_framework.md`](./design/world_design_framework.md) | Also Level 1 -- listed here only as cross-link for full-game readers |
| [`representative_area_brief.md`](./design/representative_area_brief.md) | First Representative Area experiential blueprint (Cinderwatch Ridge) -- fiction authoritative; graybox has not yet fulfilled it |
| [`exploration_framework.md`](./design/exploration_framework.md) | Also Level 1 -- listed here as cross-link for production readers |
...
1. **Level beats lower level** -- Constitutions (`vertical_slice_design_v1` for slice scope; `world_design_framework` for exploration philosophy; `exploration_framework` for Area production) beat checkpoints only for *intent*; checkpoints beat constitutions for *live mechanics*.
...
| How should Areas / exploration be designed? | `design/world_design_framework.md` |
| How should Areas be authored / reviewed / grayboxed? | `design/exploration_framework.md` |
| What is the first Representative Area? | `design/representative_area_brief.md` |
...
| Dragon knockout / revival | `checkpoints/project_checkpoint_dragon_survivability_pass1.md` |
| Enemy weapons / Brute rush | `checkpoints/project_checkpoint_enemy_combat_identity_pass1.md` |
...
| What's the graybox route (combat sandbox)? | `level/vertical_slice_level_p1.md` |
| What's Cinderwatch Ridge? | `checkpoints/project_checkpoint_cinderwatch_graybox_pass1.md` + `level/cinderwatch_ridge.md` |
...
- Design intent change -> update `vertical_slice_design_v1.md` and/or `world_design_framework.md` as appropriate.
