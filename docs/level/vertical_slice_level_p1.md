...
**World design:** [`world_design_framework.md`](../design/world_design_framework.md) -- this graybox is a combat-teaching route; named spaces are not formal World-hierarchy **Areas**  
**Representative Area:** [`representative_area_brief.md`](../design/representative_area_brief.md) -- **Cinderwatch Ridge** (new Area); P1 retained as combat sandbox until graybox replacement  
