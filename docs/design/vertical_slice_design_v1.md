...
**World / exploration constitution:** [`world_design_framework.md`](./world_design_framework.md) -- persistent world, Area hierarchy, place-making. Owns exploration philosophy; this document still owns slice scope and the combat-partnership teaching arc.

**Representative Area brief:** [`representative_area_brief.md`](./representative_area_brief.md) -- **Cinderwatch Ridge** (Emberwake Marches); quality bar for exploration-era Areas.  
**Exploration production:** [`exploration_framework.md`](./exploration_framework.md) -- Area lifecycle, graybox standards, review checklist.
...
**Level prototype:** [`vertical_slice_level_p1.md`](../level/vertical_slice_level_p1.md) -- graybox scene `scenes/world/VerticalSlice_Level_P1.tscn` (Pass 1 + P1.1 fix + **Pass 2** layout). Combat-era teaching route -- retained as sandbox. **Cinderwatch Ridge** is the exploration graybox (`Cinderwatch_Ridge.tscn`) -- Pass 1 implemented, validation failed; see [`project_checkpoint_cinderwatch_graybox_pass1.md`](../checkpoints/project_checkpoint_cinderwatch_graybox_pass1.md).
...
Post-Combat Foundation, exploration design follows [`world_design_framework.md`](./world_design_framework.md): **combat serves exploration**, places before combat rooms, and Areas (not disposable levels) as the standard unit.
...
12b. Combat Foundation chapter              <- COMPLETE
     (Combat Audio - Combat Stakes - Dragon Survivability - Enemy Combat Identity)
           v
13. World Design Framework (+ Rev 1A)        <- COMPLETE
           v
14. Representative Area Design Brief        <- COMPLETE (Cinderwatch Ridge)
           v
15. Exploration Framework -- Pass 1         <- COMPLETE
           v
16. Cinderwatch Ridge Graybox -- Pass 1     <- IMPLEMENTED; VALIDATION FAILED
           v
17. Cinderwatch Identity and Access Correction <- NEXT
           v
18. Documentation Cleanup -- Pass 2         <- future
```

Detail: [`PROJECT_STATE.md`](../PROJECT_STATE.md) - [`project_checkpoint_cinderwatch_graybox_pass1.md`](../checkpoints/project_checkpoint_cinderwatch_graybox_pass1.md) - [`cinderwatch_ridge.md`](../level/cinderwatch_ridge.md) - [`world_design_framework.md`](./world_design_framework.md) - [`exploration_framework.md`](./exploration_framework.md) - [`representative_area_brief.md`](./representative_area_brief.md) - [`vertical_slice_level_p1.md`](../level/vertical_slice_level_p1.md)
